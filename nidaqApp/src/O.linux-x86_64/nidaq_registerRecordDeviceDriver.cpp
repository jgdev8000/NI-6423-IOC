...
/* Generated from ../O.Common/nidaq.dbd */
...
epicsShareExtern typed_rset *pvar_rset_aSubRSET, *pvar_rset_aaiRSET,
    ...
    *pvar_rset_busyRSET, *pvar_rset_calcRSET, *pvar_rset_calcoutRSET,
...
static const char * const recordTypeNames[] = {
    "aSub", "aai", "aao", "ai", "ao", "asyn", "bi", "bo", "busy", "calc",
...
epicsShareExtern reg_func pvar_func_arrInitialize,
    ...
    pvar_func_drvNiDAQMEMSRegister, pvar_func_rsrvRegistrar,
...
int nidaq_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/opt/iocs/nidaq";
    ...
    runRegistrarOnce(pvar_func_drvNiDAQMEMSRegister);
...
/* nidaq_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"nidaq_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(nidaq_registerRecordDeviceDriver(*iocshPpdbbase));
}
